...
from hummingbot.connector.exchange.bitoreum.bitoreum_utils import RequestId
...
class BitoreumWebsocket(RequestId):
    ...
    def __init__(self,
                 auth: Optional[BitoreumAuth] = None,
                 throttler: Optional[AsyncThrottler] = None):
        self._auth: Optional[BitoreumAuth] = auth
