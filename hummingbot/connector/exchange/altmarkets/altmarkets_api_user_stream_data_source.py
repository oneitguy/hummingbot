...
from .bitoreum_auth import BitoreumAuth
from .bitoreum_websocket import BitoreumWebsocket


class BitoreumAPIUserStreamDataSource(UserStreamTrackerDataSource):
    ...
    def __init__(self,
        ...
        self._ws: BitoreumWebsocket = None
        super().__init__()
    ...
    async def _listen_to_orders_trades_balances(self) -> AsyncIterable[Any]:
        ...
        try:
            self._ws = BitoreumWebsocket(self._bitoreum_auth, throttler=self._throttler)
