...
BitoreumOrderBookTrackingDictionary = Dict[Decimal, Dict[str, Dict[str, any]]]

cdef class BitoreumActiveOrderTracker:
    def __init__(self,
                 active_asks: BitoreumOrderBookTrackingDictionary = None,
                 active_bids: BitoreumOrderBookTrackingDictionary = None):
        super().__init__()
    ...
    @property
    def active_asks(self) -> BitoreumOrderBookTrackingDictionary:
        return self._active_asks

    @property
    def active_bids(self) -> BitoreumOrderBookTrackingDictionary:
