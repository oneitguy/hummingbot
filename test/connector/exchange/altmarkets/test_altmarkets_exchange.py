...
class BitoreumExchangeUnitTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.connector: BitoreumExchange = BitoreumExchange(
            bitoreum_api_key=API_KEY,
            bitoreum_secret_key=API_SECRET,
            trading_pairs=[cls.trading_pair],
            trading_required=True
        )
        print("Initializing Bitoreum market... this will take about a minute.")
    ...
    def test_orders_saving_and_restoration(self):
        ...
        try:
            ...
            self.event_logger.clear()
            new_connector = BitoreumExchange(API_KEY, API_SECRET, [self.trading_pair], True)
            for event_tag in self.events:
