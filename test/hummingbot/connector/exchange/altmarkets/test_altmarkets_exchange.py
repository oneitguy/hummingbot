...
from hummingbot.connector.exchange.bitoreum.bitoreum_exchange import BitoreumExchange
...
class BitoreumExchangeTests(TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.exchange = BitoreumExchange(
            client_config_map=self.client_config_map,
            bitoreum_api_key=self.api_key,
            bitoreum_secret_key=self.api_secret_key,
    ...
    def get_in_flight_order(self,
                            ...
                            exchange_order_id: str = "someExchId",
                            amount: str = "1",
                            price: str = "5.1") -> BitoreumInFlightOrder:
        order = BitoreumInFlightOrder(
            client_order_id,
            exchange_order_id,
            self.trading_pair,
            OrderType.LIMIT,
    ...
    @aioresponses()
    @patch("hummingbot.connector.exchange.bitoreum.bitoreum_exchange.BitoreumExchange.current_timestamp")
    ...
    @aioresponses()
    @patch("hummingbot.connector.exchange.bitoreum.bitoreum_exchange.BitoreumExchange._sleep_time")
    ...
    @patch("hummingbot.connector.exchange.bitoreum.bitoreum_exchange.BitoreumExchange._update_balances")
