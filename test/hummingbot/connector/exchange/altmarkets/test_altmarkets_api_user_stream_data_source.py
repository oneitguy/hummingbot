...
class TestBitoreumAPIUserStreamDataSource(unittest.TestCase):
    @classmethod
    ...
    def setUp(self) -> None:
        ...
        bitoreum_auth = BitoreumAuth(api_key="someKey", secret_key="someSecret")
        self.data_source = BitoreumAPIUserStreamDataSource(AsyncThrottler(Constants.RATE_LIMITS), bitoreum_auth=bitoreum_auth, trading_pairs=[self.trading_pair])
