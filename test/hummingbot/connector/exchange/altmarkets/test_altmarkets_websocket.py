...
class BitoreumWebsocketTests(TestCase):
    ...
    @patch("hummingbot.connector.exchange.bitoreum.bitoreum_websocket.BitoreumWebsocket.generate_request_id")
    def test_send_subscription_message(self, request_id_mock, ws_connect_mock):
        ...
        websocket = BitoreumWebsocket(throttler=throttler)
